...
export class TraceRecorder {
    ...
    spanEnded(params) {
        ...
        if (startedAt != null)
            this.spanStarts.delete(params.spanId);
        this.record({
            type: "span_ended",
            span_id: params.spanId,
            name: params.name,
    ...
    toolCallEnded(params) {
        ...
        if (startedAt != null)
            this.toolStarts.delete(params.toolCallId);
        this.record({
...
export async function listTraceRuns(threadId) {
...
export async function readTraceRun(threadId, runId) {
...
export async function readLatestTraceRun(threadId) {
