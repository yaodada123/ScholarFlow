export function buildFallbackPlan(params) {
    ...
    return {
        ...
        thought: "I will scope the task, gather sources (optionally via web search), synthesize findings, and write a clear report.",
        steps,
    };
}
...
export function buildReporterPrompt(params) {
    ...
    const system = "You are DeerFlow Reporter. Write a high-quality markdown report. Include citations when sources are provided.";
