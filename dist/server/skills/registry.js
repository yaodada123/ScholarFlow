...
export const skillRegistry = {
    "systematic-literature-review": {
        ...
        reportTemplate: "Systematic literature review: define the review question, summarize search scope and screening criteria, synthesize themes across studies, compare methods and findings, identify gaps, and close with implications for future research.",
        requiredSections: [
    ...
    "academic-paper-review": {
        ...
        reportTemplate: "Peer-review report: identify the paper, summarize its contribution, assess soundness and novelty, list major and minor concerns, ask author questions, and provide a recommendation with confidence.",
        requiredSections: [
            "Paper Metadata",
            "Executive Summary",
    ...
    "deep-research": {
        ...
        reportTemplate: "Deep research brief: define the question, organize findings by investigation angle, compare evidence and viewpoints, identify uncertainties, and conclude with implications or next steps.",
        requiredSections: [
            "Executive Summary",
    ...
    "research-report": {
        ...
        description: "Use for complete academic research reports that need a polished paper-like structure, evidence tables, analysis, and references.",
        triggers: ["research report", "write a report", "full report", "academic report", "研究报告", "调研报告", "完整报告"],
        plannerInstructions: "Plan a complete report deliverable. Define the research question, scope, candidate argument or thesis, evidence collection plan, analysis dimensions, expected tables or figures, and limitations to disclose.",
        researcherInstructions: "Collect enough evidence to support a complete report structure. Prioritize authoritative academic and official sources, extract quotable findings with source IDs, and organize observations by report section rather than by retrieval order.",
        reporterInstructions: "Write a cohesive academic report with an explicit thesis or answer, sectioned analysis, evidence table, limitations, and references. Keep prose polished and connect evidence to the research question throughout.",
        reportTemplate: "Academic research report: answer a scoped research question with thesis-driven synthesis, methodology, structured evidence review, analysis, implications, limitations, and references.",
        requiredSections: [
            "Title",
    ...
    "proposal-report": {
        ...
        description: "Use for research proposals, thesis proposals, grant-style plans, and project proposals that need objectives, methods, feasibility, and expected contributions.",
        triggers: ["research proposal", "proposal", "thesis proposal", "grant proposal", "开题报告", "研究计划", "课题申请"],
        plannerInstructions: "Plan a proposal instead of a findings report. Define the problem, motivation, research gap, objectives, research questions or hypotheses, proposed method, data/resources, timeline, risks, ethics when relevant, and expected contributions.",
        researcherInstructions: "Gather evidence that justifies the proposal: background literature, gap evidence, methodological precedents, datasets or resources, feasibility constraints, and risks. Focus on why the proposed work is needed and viable.",
        reporterInstructions: "Write a proposal-style report with clear aims, significance, literature gap, methodology, work plan, feasibility, risks, expected contributions, and evaluation plan. Avoid presenting proposed work as completed findings.",
        reportTemplate: "Research proposal: motivate an unmet problem, establish a literature gap, define objectives and questions, propose a method and work plan, assess feasibility and risks, and state expected contributions.",
        requiredSections: [
            "Title",
