...
export function academicSearchLimit(state) {
...
export function openAiToolCallToSse(toolCall) {
    return {
        type: "tool_call",
        id: toolCall.id,
        name: toolCall.name,
...
export function buildToolCallChunks(toolCalls) {
...
export function toolResultContent(title, content) {
...
export function isLikelyChitChat(userText) {
...
export function defaultChitChatReply(params) {
...
export function parseCoordinatorDecision(text) {
...
export async function tracedNode(trace, params, fn) {
