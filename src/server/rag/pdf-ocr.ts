...
export function loadPdfOcrConfig(): PdfOcrConfig {
  return {
...
export async function ocrPdf(filePath: string, config = loadPdfOcrConfig()): Promise<{ text: string; pageCount?: number; pagesProcessed: number }> {
