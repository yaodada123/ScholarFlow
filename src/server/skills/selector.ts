...
import type { SkillId, SkillSelectionResult } from "./types.js";
...
function hasSinglePaperSignal(text: string, resources: Resource[]): boolean {
  if (matchesAny(text, reviewPaperPatterns)) return true;
...
export function selectSkills(params: { query: string; resources?: Resource[] }): SkillSelectionResult {
