export type LlmType = "basic" | "reasoning" | "vision" | "code";
...
export function loadLlmConfig(type: LlmType): LlmConfig | null {
...
export function getConfiguredModels(): Record<string, string[]> {
  const result: Record<string, string[]> = {};
  const types: LlmType[] = ["basic", "reasoning", "vision", "code"];
